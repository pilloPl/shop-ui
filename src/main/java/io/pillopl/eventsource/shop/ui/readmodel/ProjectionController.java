...
public class ProjectionController {
    ...
    private static final String SELECT_WHOLE_PROJECTION = "select uuid, status, when_bought, when_paid, when_payment_timeout, when_payment_marked_as_missing from items";
